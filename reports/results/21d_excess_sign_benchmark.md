# Quarterly Feature Design Core Benchmark 21d_excess_sign
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| logistic_regression | 0.5169 | 0.0511 | 0.4376 | 0.4097 | 1.0787 | 0.4898 | 0.5455 | -0.1574 | cpu |  |
| random_forest | 0.4960 | 0.0283 | 0.4450 | 0.5778 | 0.6851 | 0.6410 | 0.5682 | 0.1113 | cpu |  |
| xgboost | 0.5002 | 0.0240 | 0.4757 | 0.5084 | 0.7901 | 0.5250 | 0.4773 | 0.0382 | cpu | yes |
...
- Mean CV AUC: `0.5002`
- CV AUC std: `0.0240`
- Worst fold AUC: `0.4757`
- 2024 holdout AUC: `0.5084`
- 2024 holdout log loss: `0.7901`

## Interpretation

- Against the old daily/event_v1 direction (`event_v1_layer1` best model `hist_gradient_boosting`), the redesigned event setup improves best CV AUC from `0.5056` to `0.5002` and best holdout AUC from `0.5180` to `0.5084`.
