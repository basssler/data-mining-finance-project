# Quarterly Phase 9 event_specific_sentiment_only

## Locked Setup

- Primary panel: `quarterly_phase9_event_specific_sentiment_only`
- Primary label: `21-trading-day thresholded excess return (+/-1.5%)`
- Models: `logistic_regression`, `random_forest`, `xgboost`
- 2024 holdout policy: unchanged
- Frozen quarterly core anchor plus Phase 9 event-specific sentiment only.
