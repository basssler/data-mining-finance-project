# Quarterly Feature Design Core Benchmark 21d_excess_quantile
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| logistic_regression | 0.6048 | 0.1653 | 0.4074 | 0.5500 | 1.3578 | 0.5000 | 0.4000 | 0.6667 | cpu | yes |
| random_forest | 0.5199 | 0.1611 | 0.2407 | 0.4500 | 0.7198 | 0.3333 | 0.2000 | 0.2500 | cpu |  |
| xgboost | 0.4729 | 0.0708 | 0.3333 | 0.3500 | 0.9787 | 0.5714 | 0.8000 | 0.2333 | cpu |  |
...
- Mean CV AUC: `0.6048`
- CV AUC std: `0.1653`
- Worst fold AUC: `0.4074`
- 2024 holdout AUC: `0.5500`
- 2024 holdout log loss: `1.3578`

## Interpretation

- Against the old daily/event_v1 direction (`event_v1_layer1` best model `hist_gradient_boosting`), the redesigned event setup improves best CV AUC from `0.5056` to `0.6048` and best holdout AUC from `0.5180` to `0.5500`.
