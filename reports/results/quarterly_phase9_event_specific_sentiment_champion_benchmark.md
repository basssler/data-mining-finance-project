# Quarterly Phase 9 Event-Specific Sentiment Champion

## Locked Setup

- Primary panel: `quarterly_phase9_event_specific_sentiment_champion_v1`
- Primary label: `21-trading-day thresholded excess return (+/-1.5%)`
- Models: `logistic_regression`, `random_forest`, `xgboost`
- 2024 holdout policy: unchanged
- Active quarterly champion after Phase 9. Core no-market quarterly stack plus event-specific sentiment only.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| logistic_regression | 0.5682 | 0.0776 | 0.4273 | 0.4286 | 1.3617 | 0.5676 | 0.5526 | -0.1051 | cpu |  |
| random_forest | 0.5210 | 0.0324 | 0.4789 | 0.5367 | 0.6976 | 0.6452 | 0.5263 | 0.0717 | cpu | yes |
| xgboost | 0.5186 | 0.0337 | 0.4737 | 0.4680 | 0.8425 | 0.5806 | 0.4737 | 0.0099 | cpu |  |
...
- Use this as the quarterly benchmark to beat until a later phase materially improves on the same purged quarterly evaluation contract.
